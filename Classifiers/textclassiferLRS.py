import pickle
import pandas as pd
from helper.utils import get_absolute_path, TextCleaner, SpellCheckerPipeline

def classify_query(query): 
    model_file = get_absolute_path('models/fileLRS/category_classifier_model.pkl')
    mapping_file = get_absolute_path('models/fileLRS/category_mapping.pkl')
