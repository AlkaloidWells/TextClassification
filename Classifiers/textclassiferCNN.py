...
def classify_query(query):
    ...
    model = load_model(get_absolute_path('models/fileCNN/cnn_classifier_model.keras'))
    
    with open(get_absolute_path('models/fileCNN/tokenizer.pkl'), 'rb') as tok_file:
        tokenizer = pickle.load(tok_file)
        
    with open(get_absolute_path('models/fileCNN/label_encoder.pkl'), 'rb') as le_file:
        label_encoder = pickle.load(le_file)
        
    with open(get_absolute_path('models/fileCNN/category_mapping.pkl'), 'rb') as mapping_file:
